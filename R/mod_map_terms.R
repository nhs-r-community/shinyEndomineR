...
mod_map_terms_server <- function(id, merge_data){
  moduleServer( id, function(input, output, session){
    ...
    reactive({
      ...
      fieldsMapping <- c("Map_HospitalNumberIn", "Map_EndoscopistIn", "Map_ProcedurePerformedIn",
                         "Map_EndoscopyDateIn", "Map_FindingsIn", "Map_Findings2In",
                         "Map_EventsIn", "Map_MacroscopicTextIn", "Map_MicroscopicTextIn",
                         "ImageMerge_DelimTextPickersIn", "Map_MedicationsIn",
                         "Map_MacroscopicTextDelimIn", "Map_InstrumentIn", "Map_IndicationsIn")
